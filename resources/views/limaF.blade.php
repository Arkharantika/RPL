                    ...
                    <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                        ...
                        <div class="tab-pane active" id="wizard-validation-classic-step1" role="tabpanel">
                            ...
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Judul Buku / Monograf / Standard and Code / Patent / Proceeding Seminar :</label>
                            ...
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Link G-Drive Nomer contoh atau fotokopi buku/monograf/standar dan code/patent/proceeding seminar dll
                                    :</label>
