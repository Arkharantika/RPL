                    ...
                    <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                        ...
                        <div class="tab-pane active" id="wizard-validation-classic-step1" role="tabpanel">
                            ...
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Judul Makalah Pada Pertemuan Profesi :</label>
                                <textarea type="form-control" class="form-control" placeholder="" name="judul"
                                    id="judul" required></textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Waktu dan Tempat Pertemuan Profesi :</label>
                                <textarea type="form-control" class="form-control" placeholder="hai" name="waktu"
                                    id="waktu" required></textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Nama Penyelenggara Pertemuan Profesi
                                    :</label>
                                <textarea type="form-control" class="form-control" placeholder="" name="nama_alamat"
                                    id="nama_alamat" required></textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Jumlah Peserta Pertemuan Profesi
                                    :</label>
                                <textarea type="form-control" class="form-control" placeholder="" name="kedudukan"
                                    id="kedudukan" required></textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><i class="bx bx-caret-right"></i>Jenis Pertemuan Profesi (Lokal, Nasional, Internasional) :</label>
